...
function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!NAME_PATTERN.test(trimmedName)) {
      setError("Name can only contain letters, spaces, and characters like ' or - (no numbers or symbols).");
      return;
    }

    setLoading(true);
    try {
      const res = await api.post("/auth/register", { ...form, name: trimmedName });
      ...
      >
        <div className="relative z-10">
          ...
          <h1 className="text-4xl font-bold leading-tight mb-4">
            Join InsureSure Today.
          </h1>
          <p className="text-lg max-w-md leading-relaxed" style={{ color: "#D8F3DC" }}>
            Create an account to manage policies, submit claims, and track
            every premium payment in one secure place.
          </p>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          ...
          <p className="text-sm text-slate-500 mb-6 text-center lg:text-left">
            Get started managing your insurance in minutes
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                title="Only letters, spaces, and characters like ' or - are allowed"
